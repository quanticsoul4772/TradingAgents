...
**Look-ahead bias RULED OUT (2026-05-05 night, `claudedocs/finding4-strict-prior-ic-2026-05-05.md`)**: re-computed within-ticker IC using strict-prior percentile (vs prior dates of same ticker only, no look-ahead) on the same row subsets. Result: median IC is essentially identical to the original at both floors — N≥5: -0.4534 (original) vs -0.4441 (strict-prior), Δ +0.0093; N≥20 (NVDA only): -0.7473 vs -0.7428, Δ +0.0045. Finding #4's headline statistic is robust, NOT a look-ahead artifact. **Explanation #3 rejected.** NVDA-specific result is striking: at production floor (N≥20), NVDA carries the within-ticker contrarian signal more strongly (-0.74) than the corpus median (-0.49) — and the retrospective's 2 NVDA fires both had negative α as predicted. The gate likely works at production floor; the corpus just can't test enough tickers there yet. Explanation #1 (low-N percentile noise) is upgraded to leading hypothesis. Spec 003 FR-004's N≥20 floor is specifically defending against this. SC-002 fresh data at production floor remains the discriminating evidence.
