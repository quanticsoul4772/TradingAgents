# Product-build path step 1: signal at scale on 50-ticker batch
...
& uv run --no-sync python scripts/backtest.py `
    ...
    --start 2026-04-03 --end 2026-04-03 --frequency W `
    --max-runs 50 --analysts market,news,fundamentals --debate-rounds 1 `
    --provider anthropic --deep-model claude-opus-4-7 --quick-model claude-haiku-4-5 `
    --news-vendor exa `
