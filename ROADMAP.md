...
| Does BR-3 v2 (news + fundamentals analyst structured-output) generalize the BR-3 v1 +20pp commit-shift effect beyond market analyst? | Background pilot launched 2026-05-09 evening (PR #214; background ID `bkpnb5www`). ETA ~8h (lands 2026-05-10). 2 sub-experiments × 5 dates × 2 tickers × 2 modes = 40 propagates. Per ANALYSIS_TEMPLATE.md, 5 verdict-conditional branches per sub-experiment (NULL / ALT-A / ALT-B / PARTIAL ALT-B / DIFFERENTIAL across A vs B). | $16 (T2; user-authorized) | **in flight (BR-3 v2)** |
