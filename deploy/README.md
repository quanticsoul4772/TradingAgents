...
Older systemd silently interprets `OnCalendar=Mon..Fri 17:00 America/New_York` as UTC, which would fire the daily timer at the wrong wall-clock time (13:00 ET in summer, 12:00 ET in winter, instead of 17:00 ET). One-line gate that exits non-zero on older systemd:
