# WC-10 dry-run digest — 2026-04-15
...
**Source**: experiments/2026-05-08-001-wc-10-pilot/results.csv (2 tickers on `2026-04-15`)
...
|---|---|---|---|---|
| AAPL | `+0.5200` → Overweight | Underweight | **yes** | +4.71% (days=17) |
| NVDA | `+0.7200` → Buy | Hold | **yes** | +2.83% (days=17) |

---

## Branch A — WC-10 mode (`--wc-10-enabled`)

**Actionable**: 2  | **Filtered (Hold / Underweight / Sell)**: 0


### Actionable signals (Buy / Overweight)

- **AAPL** — Overweight (scalar `+0.5200`) — realized 21d α = `+4.71%` (days=17)
- **NVDA** — Buy (scalar `+0.7200`) — realized 21d α = `+2.83%` (days=17)
...
- **AAPL** — Underweight — realized 21d α = `+4.71%` (days=17)
- **NVDA** — Hold — realized 21d α = `+2.83%` (days=17)
...
- WC-10 mode produced **2 actionable signals** of 2; baseline produced **0 actionable**.
