# Sector-α attribution analyzer — 2026-05-10
...
**Corpus**: 303 unique commits → 263 with sector + ETF + valid forward returns
...
## Bullish commits (n=83) — cell distribution + means

| Cell | n | share | mean α vs SPY | mean α vs sector | mean raw |
|---|---|---|---|---|---|
| `ticker_strong` | 29 | 34.9% | +8.94% | +7.64% | +12.68% |
| `sector_tide_up` | 21 | 25.3% | +2.37% | -3.49% | +7.32% |
| `sector_drag` | 6 | 7.2% | -3.87% | +2.66% | +5.80% |
| `ticker_weak` | 27 | 32.5% | -5.34% | -5.80% | -2.97% |
...
| Technology | XLK | 65 | 24 | 36.9% | -4.39% | -5.86% |
